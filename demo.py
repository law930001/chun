...
class demo_Model(Model):
    ...
    def demo(self, img_path, short_size: int = 1280):
        '''
...
if __name__ == '__main__':
    ...
    model_path = '../chun_saves/output_pan/epoch_99_iter_24700.pth'

    img_id = 10

    dirs = os.listdir('/root/Storage/datasets/plate/AIUnion/Img/')
    ...
    for i, file in enumerate(dirs):
        ...
        img_path = '/root/Storage/datasets/plate/AIUnion/Img/{}'.format(file)
